...
contract EchidnaProxy {
    ...
    // Borrower Operations
    function openTrovePrx(uint256 _ETH, uint256 _LUSDAmount, address _upperHint, address _lowerHint, uint256 _maxFee)
        external
        payable
    {
    ...
    function withdrawLUSDPrx(uint256 _amount, address _upperHint, address _lowerHint, uint256 _maxFee) external {
        borrowerOperations.withdrawLUSD(_maxFee, _amount, _upperHint, _lowerHint);
    }

    function repayLUSDPrx(uint256 _amount, address _upperHint, address _lowerHint) external {
    ...
    function adjustTrovePrx(
        ...
        borrowerOperations.adjustTrove{value: _ETH}(
            _maxFee, _collWithdrawal, _debtChange, _isDebtIncrease, _upperHint, _lowerHint
        );
    }
